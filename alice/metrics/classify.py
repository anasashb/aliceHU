...
def accuracy(y_true, y_pred):
    '''
    Calculates classification accuracy given true and predicted target values.
    '''
    return np.sum(y_true == y_pred) / len(y_true)

def precision(y_true, y_pred):
    '''
    Calculates classification precision given true and predicted target values.
    '''
...
def recall(y_true, y_pred):
    '''
    Calculates classification recall given true and predicted target values.
    '''
    tp = np.sum((y_true == 1) & (y_pred == 1))
